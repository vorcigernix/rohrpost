...
export const LawnTheme = defineTheme({
  name: 'Lawn',
  tokens: {
    '--color-accent': 'light-dark(#3E481D, #7A9C30)',
    '--color-accent-muted': 'light-dark(#50660B33, #BBCF7440)',
    ...
    '--color-text-accent': 'light-dark(#374E00, #BBCF74)',
    '--color-on-dark': '#FFFFFF',
    '--color-on-light': '#3E481D',
    '--color-icon-accent': 'light-dark(#50660B, #BBCF74)',
    ...
    '--color-border-emphasized': 'light-dark(#AAAD9E, #46483B)',
